...
各行の頭の【　】は区切りではなく、**印**である。印は2種類ある。

| 印 | 意味 |
|---|---|
| **【事前】【現場】【下請】【見積】** | その工程が**誰の・いつ**の作業か |
| **【デモ】** | 商談で**相手が実際に触って見る**工程。**この3つだけがタップになる** |
| **【サンプル】** | デモの開始時点で**中身が入った状態で用意される**工程。相手は触らない |

**【デモ】と【サンプル】は排他ではない。** 比較表（工程13・14）は、
**中身がサンプルで、画面は相手が触る**ので両方付く。
...
12. 【下請】【サンプル】 見積もりを送る
              1回だけ。送ったあとは書き換えられない
              デモでは3社とも送信済みの状態にしてある

13. 【見積】【デモ】【サンプル】 下請けからの見積もりを受け取る
              返ってきた会社から順に、比較表に並ぶ
              ← デモではここに着地する。3社ぶんが既に並んでいる

14. 【見積】【デモ】【サンプル】 見積もり比較、決定
              工事ごとに3社の単価が横に並ぶ
              最安に印が付くが、自動では決まらない
              工事ごとに1社ずつ「採用」を押す（別々の会社を選べる）
              ← デモでは採用済み。押し直して見せられる（タップは増やさない）

15. 【見積】【サンプル】 下請け見積もりを基に顧客向け見積もりを作る
...
1タップ目を押した瞬間に、**【サンプル】の工程が全部書き込まれる**。
